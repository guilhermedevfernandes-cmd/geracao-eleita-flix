#!/usr/bin/env python3
"""Montagem do EP12 — Moisés e o Mar Vermelho (padrão EP03: multi-plano, cortes secos
na cena, fade branco entre cenas, BGM 0.10/0.065/0.08, reflexão com bgm própria,
clipes 0.75x, SEM sininhos)."""
...
CENAS = [
    ...
    ("c2", ["c2_0"], ["c2p1","c2p2"], False, []),
    ("c3", ["c3_0","c3_1","c3_2"], ["c3p1","c3p2","c3p3"], False, [("fogo-crepitar",2,0.18)]),
    ("c4", ["c4_0"], ["c4p1","c4p2","c4p3"], False, []),
    ("c5", ["c5_0"], ["c5p1","c5p2","c5p3"], False, [("vento-mar",1,0.18)]),
    ("c6", ["c6_0","c6_1","c6_2"], ["c6p1","c6p2","c6p3"], False, [("vento-mar",6,0.25)]),
    ("c7", ["c7_0"], ["c7p1","c7p2"], False, [("splash-fofo",3,0.30)]),
    ("c10", ["c10_full"], ["c2p2","c3p1","c6p2","c7p2","c1p1"], False, []),
]
...
final = os.path.join(EP,"EP12-PREVIEW-MOISES-E-O-MAR-VERMELHO.mp4")
