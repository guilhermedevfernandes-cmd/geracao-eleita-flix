#!/bin/zsh
# Produz o guia de contingência para animação manual no OpenArt.
...

{
  ...
  echo
  echo "1. Use o OpenArt com Seedance/Kling em alta qualidade, $ASPECT, ${VIDEO_DUR}s."
  echo "2. Use \`frames/NN.png\` como imagem inicial."
