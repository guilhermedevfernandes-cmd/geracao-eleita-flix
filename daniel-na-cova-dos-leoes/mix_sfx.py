...
SFX_MAP = {
    "01": ("sfx/amb-reino.mp3", 0.13),   # ambiência do reino (abertura)
    "27": ("sfx/pedra.mp3",     0.26),   # pedra rolando p/ selar a cova
    "28": ("sfx/leoes.mp3",     0.28),   # leões rugindo (manso, não assustador)
    "30": ("sfx/luz-anjo.mp3",  0.18),   # luz do anjo (brilho sagrado)
    "38": ("sfx/multidao.mp3",  0.20),   # multidão comemorando
}
