#!/usr/bin/env python3
"""Montagem do EP10 — O Batismo de Jesus (padrão EP03/EP09: multi-plano, cortes secos na cena,
...
CENAS = [
    ...
    ("c3", ["c3_0"], ["c3p1","c3p2"], False, [("vento-suave",1.0,0.18)]),
    ("c4", ["c4_0"], ["c4p1","c4p2"], False, [("harpa-v2",1.0,0.18),("surpresa-fofa",7,0.28)]),
    ("c5", ["c5_0"], ["c5p1","c5p2"], False, [("aguinha",1.0,0.22)]),
    ("c6", ["c6_0"], ["c6p1","c6p2"], False, [("aguinha",1.0,0.25),("sininhos-v2",8,0.22)]),
    ("c7", ["c7_0","c7_1"], ["c7p1","c7p2","c7p3"], False, [("harpa-v2",1.0,0.20),("sininhos-v2",14,0.22)]),
    # REFLEXÃO: 3 lições + bordão + tchau — request único, trilha própria
    ("c10", ["c10_full"], ["c2p3","c4p2","c6p1","c7p2","c1p1"], False, [("sininhos-v2",0.5,0.22)]),
]
...
final = os.path.join(EP,"EP10-PREVIEW-O-BATISMO-DE-JESUS.mp4")
