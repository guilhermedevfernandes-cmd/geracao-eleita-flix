...
# v2 (13/07/2026): baleia gigante (c5p2/c6p3 novos), oração com gratidão+obediência
# (c6_0 regravado), SEM sininhos (som de "chocalho" apontado pelo usuário).
CENAS = [
    ("c1", ["c1_0"], ["c1p1","c1p2"], False, []),
    ("c2", ["c2_0","c2_1"], ["c2p1","c2p2","c2p3"], False, [("harpa-v2",1.0,0.18)]),
    ("c3", ["c3_0"], ["c3p1","c3p2","c3p3"], False, [("apito-barco",8,0.22)]),
    ("c4", ["c4_0"], ["c4p1","c4p2","c4p3"], False, [("vento-mar",1.5,0.25),("splash-fofo",14,0.30)]),
    ("c5", ["c5_0"], ["c5p1","c5p2","c5p3"], False, [("glub",4,0.28),("bolhinhas",8,0.28)]),
    ("c6", ["c6_0"], ["c6p1","c6p2","c6p3"], False, [("harpa-v2",2,0.18),("splash-fofo",13,0.30)]),
    ("c7", ["c7_0","c7_1","c7_2"], ["c7p1","c7p2","c7p3"], False, []),
    ("c10", ["c10_full"], ["c1p2","c2p2","c5p3","c6p3","c7p3"], False, []),
]
...
final = os.path.join(EP,"EP05-PREVIEW-JONAS-E-A-BALEIA-AMIGA.mp4")
