...
SFX_MAP = {
    "01": ("sfx/amb-jardim.mp3",  0.13),  # ambiência do jardim do Éden (abertura)
    "02": ("sfx/luz-criacao.mp3", 0.16),  # sopro de vida / luz da criação
    "13": ("sfx/serpente.mp3",    0.18),  # sibilo sutil da serpente (tentação)
    "23": ("sfx/espada-fogo.mp3", 0.20),  # espada de fogo do anjo na saída do Éden
}
